...
export const STRINGS = {
  en: {
    ...
    feedEmptyFav1: 'No favorites yet.',
    feedEmptyFav2: 'Tap the star on a sound to add it.',
    play: 'Play',
    stop: 'Stop',
    loop: 'Loop',
    layer: 'Layer',
    ...
    mixEmptyFav: 'No favorites yet — tap the star on a sound to add one.',
  ...
  ja: {
    ...
    feedEmptyFav1: 'お気に入りはまだありません。',
    feedEmptyFav2: '星をタップしてお気に入りに追加。',
    play: '再生',
    stop: '停止',
    loop: 'ループ',
    layer: '重ねる',
    ...
    mixEmptyFav: 'お気に入りはまだありません。星をタップして追加してください。',
